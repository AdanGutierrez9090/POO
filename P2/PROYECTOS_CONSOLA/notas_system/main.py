...
from model import usuariosBD, notasBD
    ...
    while True:    
      ...
      .::  Menu Principal ::. 
        ...
        if opcion == '1' or opcion=="REGISTRO":
            ...
            #Agregar codigo
            resultado=usuariosBD.Usuario.registrar(nombre,apellidos,email,password)
            if resultado:
            ...
            password=getpass.getpass("\t Ingresa tu Contraseña: ")
            #Agregar codigo 
            registro=usuariosBD.Usuario.iniciar_sesion(email,password)
            if registro:
...
def menu_notas(usuario_id,nombre,apellidos):
    while True:
        ...
        if opcion == '1' or opcion=="CREAR":
            ...
            #Agregar codigo
            resultado=notasBD.Notas.crear(usuario_id,titulo,descripcion)
            if resultado:
            ...
            borrarPantalla()
            #Agregar codigo  
            registros=notasBD.Notas.mostrar(usuario_id)
            if len(registros)>0:
            ...
            #Agregar codigo
            resultado=notasBD.Notas.actualizar(id,titulo,descripcion)
            if resultado:
